...
<h3> First name:</br>
 <input type="text" size="80" name="firstname"  placeholder="Type your First name here" required><br/><br/>
 
<h3> Last name:<br>
 <input type="text" size="80" name="lastname"  placeholder="type your last name here" required><br/><br/>
 
 
 
 <h3>Mobile/land number:<br/>
 <input type="phone"  size="80" name="mobile" pattern="[0-9]{10}"  placeholder="xxxxxxxxxx" required> <br/><br/>
 
 <h3>E-mail:<br/>
 <input type="email" size="80"  name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}.$"  placeholder="abc@gmail.com" required><br/><br/>
 
<h3> Address:<br/>
 <textarea name="address"  placeholder="type your address here" required></textarea><br><br/>
 
 
 <h3>Chooose your DOB:<br/>
 <input type="date" size="80" name="day" required> <br/><br/>
 <font color="red">
 <h3>Password:<br/>
 <input type="password" name="pwd" placeholder="Enter Password" size="80" required><br/>
 
 
 <br/>
 
 <h3>Re-enter Password:<br/>
 <input type="password" id="cnfrmpwd" name="reEnter" placeholder="Reenter Password" size="80" required><br/><br/>
 <br>
 </hr>
