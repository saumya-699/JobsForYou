...
<center> <img src="images/ashi.png" class="sin"></center>
        ...
        <div class="mid">
                        ...
                        <b> <font size=6><font color="red">Company Name</font></font></b><br>
                             <input type="text" placeholder="Company Name" name="CompanyName" class="validation" id="userName"  required><br><br>
        

                       <b><font size=6><font color="green">Rank</font></font></b><br>
                            <input type="text" placeholder="Rank" name="Rank"  class="validation"  id="fName"  required><br> <br>
