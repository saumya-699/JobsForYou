     ...
     <img src="images/updateacountIMG.jpg" class="sin" > 
        ...
        <div class="passwordDiv">
                          ...
                          <b> <font size=5><font color="purple">Company Name</font></font></b><br>
                             <input type="text" placeholder="Company Name" name="CompanyName"  class="staff" title="Must contain atleat 3 characters" ><br><br>
                       ...
                       <b><font size=5><font color="green">New rank</font></font></b><br>
                            <input type="text" placeholder="New RSank" name="NewRank"  class="staff" required><br><br>
